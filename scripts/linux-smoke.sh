...
: "${PI_LINUX_PI_ARCHIVE:?Set PI_LINUX_PI_ARCHIVE to an absolute path to a credential-free prebuilt Linux Pi .tar.gz (top-level pi/) containing acf4c2d98; stock Pi 0.84 and 0.85.1 lack the required custom-queue contract.}"
