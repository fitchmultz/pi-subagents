...
const sessionModule: Pick<typeof import("@earendil-works/pi-coding-agent"), "buildSessionContext" | "parseSessionEntries" | "SessionManager"> = await import(pathToFileURL(path.join(root, "dist/index.js")).href);
