...
const RUNNER_DYNAMIC_STEP_KEYS = new Set([...DYNAMIC_STEP_KEYS, "effectiveAcceptance", "sessionFiles"]);
...
const RUNNER_DYNAMIC_PARALLEL_KEYS = new Set([
	...
	"outputName", "structured", "inheritProjectContext", "inheritSkills", "skills", "outputPath", "outputPathFromAgentDefault", "defaultOutputSource", "allowSubagents", "maxSubagentDepth",
