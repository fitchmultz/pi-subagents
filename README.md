...
|---------------|--------|
| `cloudflare-ai-gateway/claude-opus-5` | `context-builder`, `debugger`, `fixer`, `planner`, `reviewer`, `reviewer-claude`, `ui-designer` |
| `cloudflare-ai-gateway/claude-fable-5` | `writer` |
