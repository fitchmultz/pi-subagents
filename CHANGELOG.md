...
### Added
- Carry the authoritative root Pi session ID through existing foreground/background launch, nested delegation, and saved revive metadata without changing the parent's process environment.
