...
for (const variant of ["restart", "compaction", "branch", "fork", "steering", "steering-disconnect"]) test(`native delegation survives ${variant} with the original call and one usage charge`, { timeout: 90_000 }, (t) => {
